...
class SampleAssistant(object):
    ...
    def update_conversation_stream(self,stream):
        self.conversation_stream = stream
...
@click.option('--once', default=True, is_flag=True,
...
def main(api_endpoint, credentials, verbose,
    ...
    # Start hotword detection and keep the assistant running.
    while True:
        hotwordDetection = porcupine.Porcupine()
        print("Say a hotword to activate the assistant.")
        hotwordDetection.activate()
